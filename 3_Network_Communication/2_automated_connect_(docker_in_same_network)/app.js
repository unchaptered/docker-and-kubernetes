 ...
 * Dockerize MongoDB + Dockerize Node.js : 'mongodb://${DOCKERIZED ADDRESS(checkout README.md)}:27017/swfavorites'
 * Dockerize MongoDB + Dockerize Node.js in Same Netowrk : 'mongodb://${CONTAINER NAME}:27017/swfavorites'
 */
mongoose.connect(
